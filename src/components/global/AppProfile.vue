<template>
      ...
      <div class="mx-auto max-w-7xl ">
        <div class="p-8">
          <div class="flex items-start justify-between mb-8">
            ...
            <button @click.prevent="isOpen=true" class="px-4 py-2 text-white transition-colors rounded-lg bg-violet-600 hover:bg-violet-700">
              <span class="hidden sm:block">Edit Profile</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-pen sm:hidden"><path d="M11.5 15H7a4 4 0 0 0-4 4v2"/><path d="M21.378 16.626a1 1 0 0 0-3.004-3.004l-4.01 4.012a2 2 0 0 0-.506.854l-.837 2.87a.5.5 0 0 0 .62.62l2.87-.837a2 2 0 0 0 .854-.506z"/><circle cx="10" cy="7" r="4"/></svg>
            </button>
          </div>
  ...
  const profile = ref({
    ...
    avatar: 'https://i.pinimg.com/236x/50/e3/0e/50e30ea061634f6d46d13a156770771f.jpg',
    ...
    reviews: [
      {
        name: 'Alice Johnson',
        avatar: 'https://i.pinimg.com/236x/ee/b0/e1/eeb0e16706c9c0275f4a0a7cd43a71b7.jpg',
        comment: 'John is extremely professional and responsive. He helped me find my dream home in record time!',
        rating: 5
      },
      {
        name: 'Bob Smith',
        avatar: 'https://i.pinimg.com/736x/6c/f9/6d/6cf96d942064d49fea2871fe926b81cc.jpg',
