...
console.log(route);
  ...
  const menus = [
    { id: 1, name: 'Dasboard',route:{'name':"companies-dashboard",params:{compainy_id:route.params.compainy_id}} },
    ...
    { id: 4, name: 'Setting',route:{'name':"companies-setting",params:{compainy_id:route.params.compainy_id}}  },
  ]
